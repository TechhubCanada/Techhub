...
export default function AccountLayout(props: { children: React.ReactNode }) {
  return (
    <div className="flex max-md:flex-col">
      <div className="sticky left-0 shrink-0 z-30 top-0 md:max-w-75 lg:max-w-93 py-2 max-md:mt-18 max-md:top-18 md:pt-45 md:pb-9 max-md:border-b max-md:border-grayscale-200 max-md:overflow-x-auto max-md:no-scrollbar bg-white md:bg-grayscale-50 w-full md:h-screen">
